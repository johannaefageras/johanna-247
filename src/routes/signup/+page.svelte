...
<svelte:head>
	<title>Skapa konto — Johanna 24/7</title>
</svelte:head>
...
<main class="main">
	<div class="auth-card">
		<h1 class="auth-heading">Skapa konto</h1>
		<p class="auth-subtext">Kom igång med Johanna 24/7.</p>

		{#if form?.success}
			<div class="auth-success">
				<p><strong>Kolla din e-post!</strong></p>
				<p>Vi har skickat en bekräftelselänk till <strong>{form.email}</strong>.</p>
			</div>
		{:else}
			{#if form?.error}
			...
			<form method="POST" use:enhance class="auth-form">
				...
				<button class="auth-btn" type="submit">Skapa konto</button>
			</form>
