...
<svelte:head>
	<title>Logga in — Johanna 24/7</title>
</svelte:head>
...
<main class="main">
	<div class="auth-card">
		<h1 class="auth-heading">Logga in</h1>
		<p class="auth-subtext">Välkommen tillbaka.</p>
		...
		<form method="POST" use:enhance class="auth-form">
			...
			<button class="auth-btn" type="submit">Logga in</button>
		</form>

		<div class="auth-links">
			<a href="/signup">Skapa konto</a>
			<span class="auth-links-sep">&middot;</span>
			<a href="/reset-password">Glömt lösenord?</a>
		</div>
	</div>
</main>
